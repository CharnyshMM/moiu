...
# # Zadacha2 jpg
# c_vect__t = np.matrix([[-6, -9, -5, 2, -6, 0, 1, 3]])

# x_vector__t = [4, 0, 6, 6, 0, 0, 3, 0]
...
def solve(A_matrix, c_vect__t, x_vector__t, J_b):
    ...
    while True:
        ...
        if q0 == math.inf:
            ...
            raise ValueError("The objective function is not limited in this problem")
